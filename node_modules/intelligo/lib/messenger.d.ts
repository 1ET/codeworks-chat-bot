...
export declare class MessengerBot extends EventEmitter {
     ...
     * @param {String} url URL of the attachment.
     */
    sendFileMessage(recipientId: any, url: any): void;
    /**
     * @param {Recipient|String} recipientId
     * @param {String} url URL of the attachment.
     */
    sendImageMessage(recipientId: any, url: any): void;
    /**
     * @param {Recipient|String} recipientId
     * @param {String} url URL of the attachment.
     */
    sendVideoMessage(recipientId: any, url: any): void;
    /**
     * @param {Recipient|String} recipientId
     * @param {String} url URL of the attachment.
     */
    sendAudioMessage(recipientId: any, url: any): void;
    /**
     * @param {Recipient|String} recipientId
