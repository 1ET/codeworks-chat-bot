...
export declare type SendAPIRequest = SenderActionRequest | MessageRequest;
...
export declare type SenderAction = 'typing_on' | 'typing_off' | 'mark_seen';
export declare type MessagingType = 'RESPONSE' | 'UPDATE' | 'MESSAGE_TAG';
...
export declare type QuickReplyContentType = 'text' | 'location' | 'user_phone_number' | 'user_email';
...
export declare type FeatureReviewStatus = 'PENDING' | 'REJECTED' | 'APPROVED' | 'LIMITED';
...
export declare type RequestedUserInfo = 'shipping_address' | 'contact_name' | 'contact_phone' | 'contact_email';
